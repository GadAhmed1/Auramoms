        ...
        <main className=' h-screen'>
            <section className="">
                ...
                <div className="flexCenter py-10">
                    ...
                    <div className="my-2 mx-20 mb-16 p-10 lg:w-[600px] md:w-96 sm:w-80 xs:w-80 rounded-2xl shadow-2xl shadow-BabyBlueColor dark:shadow-BabyBlueColor border-2  dark:shadow-lg">
                        {/* Contact header with icons */}
                        <div className="flexCenter gap-2 text-2xl font-semibold ">
                            <span className=''>Contact Our</span>
                            <SiGmail className="text-blue-600" /> {/* Gmail icon */}
                        </div>

                        <div className=''>
                            {/* Form with ref attribute and onSubmit event handler */}
                            <form ref={form} className='py-10' onSubmit={sendEmail} autoSave="true">
                                ...
                                <div className="flexCenter mt-5 gap-2">
                                    ...
                                    <button type='submit' className=" flexCenter px-6 py-1 bg-blue-600 text-white rounded-lg text-xl cursor-pointer hover:bg-BabyBlueColor hover:text-black transition-all">
                                        Send <IoIosSend className="mt-1 ms-1" /> {/* Send icon */}
                                    </button>

                                    {/* Reset button with hover effects */}
                                    <button type='reset' className="flexCenter px-6 py-1 bg-red-600 hover:bg-PinkColor text-white rounded-lg text-xl cursor-pointer hover:text-black transition-all">
                                        Reset
                                    </button>
                                </div>
                                ...
                                <div className=' flexCenter mt-8'>
                                    <Socialicons /> {/* Social media icons component */}
                                </div>
                            </form>
                        </div>
                    </div>
