  ...
  return (
    <section className="min-h-screen bg-white py-12 px-4 dark:bg-gray-900 text-gray-100 ">
      <motion.div
        ...
        transition={{ duration: 0.6 }}
      >
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mx-auto dark:bg-gray-800 border-2 border-gray-200 flex">
          ...
          <div className="w-1/2">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d110574.2913660733!2d31.2357116!3d30.0444196!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x145840c5b4d1e5b1%3A0x4c5b4c5b4c5b4c5b!2sCairo%2C%20Egypt!5e0!3m2!1sen!2sus!4v1633021234567!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen=""
