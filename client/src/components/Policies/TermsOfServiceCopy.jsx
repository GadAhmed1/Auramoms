...
const PrivacyPolicy = () => {
  return (
    <>
    <div className="bg-gray-50 text-gray-800 p-6 md:p-12 dark:bg-DarkBackground">
      <div className="max-w-4xl mx-auto dark:text-gray-400">
        ...
        <p className="mb-4 leading-7">
          This Privacy Policy describes how AuraMoms (the &#34;Site&#34;, &#34;we&#34;, &#34;us&#34;, or
          &#34;our&#34;) collects, uses, and discloses your personal information when
          you visit, use our services, or make a purchase from www.auramoms.com
        ...
        <ul className="list-disc pl-6 mb-4">
          <li><span className="font-bold">Contact details</span> including your name, address, phone number, and email.</li>
          <li><span className="font-bold">Order information</span> including your name, billing address, shipping address, payment confirmation, email address, and phone number.</li>
          <li><span className="font-bold">Account information</span> including your username, password, security questions and other information used for account security purposes.</li>
          <li><span className="font-bold">Customer support communications</span>including the information you choose to include in communications with us, for example, when sending a message through the Services.</li>
        </ul>
        <p>
        ...
        <table className="min-w-full border-collapse border border-gray-200">
          <thead>
            <tr className="bg-gray-100">
              <th className="border border-gray-200 px-4 py-2 text-left dark:text-black">Category</th>
              <th className="border border-gray-200 px-4 py-2 text-left dark:text-black">Categories of Recipients</th>
            </tr>
          </thead>
          <tbody>
            <tr>
